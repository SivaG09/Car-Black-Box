/*
 * File: main.c
 * Name: Sivasubramanian G
 * Date: 07/02/24
 * Description: This Project gives solution to log all the critical events like the gear shifts with current speed,
...
if required.
 * This project aims to implement the core functionalities of a car black box in a PIC-based microcontroller supported 
 by its peripherals. Events will be logged in EEPROM in this project. This project can be extended further to any vehicle
 */
...
void main(void) {
    ...
    /*This password is the combination of 2 user keys --> key 4 & key 5 of DKP*/
